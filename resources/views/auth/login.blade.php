...
<div class="container mx-auto flex justify-center">
    <div class="block mb-2 mr-8 uppercase font-bold text-2xl text-gray-700">Login</div>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <a href="{{ route('password.request') }}" class="text-s text-gray-700">
                Forgot Your Password?
            </a>
        </div>

        <a href="{{ route('register') }}" class="ml-24 text-s text-gray-700">
